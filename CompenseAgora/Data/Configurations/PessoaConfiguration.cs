...
public class PessoaConfiguration : IEntityTypeConfiguration<Pessoa>
{
    public void Configure(EntityTypeBuilder<Pessoa> builder)
    {
        ...
        builder.Property(p => p.Endereco).HasMaxLength(250).IsRequired();
        builder.Property(p => p.Bairro).HasMaxLength(150).IsRequired();
        builder.Property(p => p.Numero).HasMaxLength(20).IsRequired();
        builder.Property(p => p.Cidade).HasMaxLength(150).IsRequired();
        builder.Property(p => p.Estado).HasMaxLength(100).IsRequired();
        builder.Property(p => p.Pais).HasMaxLength(100).IsRequired();
        builder.Property(p => p.Celular).HasMaxLength(20).IsRequired();
